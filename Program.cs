    ...
    .ConfigureServices(services =>
    {
        ...
        services.AddMassTransit(x =>
        {
            ...
            x.UsingRabbitMq((context, cfg) =>
            {
                ...
                cfg.UseDelayedRedelivery(r => r.Intervals(TimeSpan.FromSeconds(5), TimeSpan.FromMinutes(5), TimeSpan.FromMinutes(15), TimeSpan.FromMinutes(30))); // unknown exchange type 'x-delayed-message'
